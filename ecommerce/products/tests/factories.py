...
class CategoryFactory(DjangoModelFactory):
    ...
    created_by = factory.SubFactory(UserFactory, username="testadminuser")
...
class ProductFactory(DjangoModelFactory):
    ...
    owner = factory.SubFactory(UserFactory, username="testadminuser")
...
class ProductLineFactory(DjangoModelFactory):
    ...
    product = factory.SubFactory(ProductFactory, product_lines=None)
...
class ProductImageFactory(DjangoModelFactory):
    ...
    product = factory.SubFactory(ProductFactory, images=None)
...
class ProductAttributeFactory(DjangoModelFactory):
    ...
    product_line = factory.SubFactory(ProductLineFactory, attributes=None)
